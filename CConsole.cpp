...
/*
*/
CConsole::CConsole(CGraphicsAdapter* graphicsAdapter, CErrorLog* errorLog, CPipelineState* pipelineState, int32_t listGroup, CTexture* texture, CFont* font,
	int32_t width, int32_t height)
{
	...
	m_background = new CImage(m_graphicsAdapter, m_errorLog, pipelineState, listGroup, m_texture, m_position, m_size);
}
