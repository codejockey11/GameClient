...
/*
*/
CButton::CButton(CGraphicsAdapter* graphicsAdapter, CSoundDevice* soundDevice, CMouseDevice* mouseDevice, CErrorLog* errorLog, CPipelineState* pipelineState, int32_t listGroup,
	const char* name, CFont* font, CWavLoader* soundOn, CWavLoader* soundOff, CWavLoader* soundClicked, CTexture* texture, CVec2f position, CVec2f size, BYTE audience, BYTE type)
{
	...
	m_image = new CImage(m_graphicsAdapter, errorLog, pipelineState, listGroup, texture, m_position, m_size);
