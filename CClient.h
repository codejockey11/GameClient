...
public:
	...
	uint32_t m_loadEnvironmentThreadId;
	uint32_t m_receiveAccountThreadId;
	...
	TMethod m_event[CNetwork::ClientEvent::E_CE_MAX_EVENTS];
	...
	static unsigned __stdcall LoadPlayerThread(void* obj);
};