...
CShaderBinaryManager::CShaderBinaryManager(CGraphicsAdapter* graphicsAdapter, CErrorLog* errorLog, CLocal* local)
{
	...
	*/
	...
	for (int32_t i = 0; i < 11; i++)
	{
		...
		m_hr = m_graphicsAdapter->m_device->CheckFeatureSupport(D3D12_FEATURE::D3D12_FEATURE_SHADER_MODEL, &m_shaderModelCheck, sizeof(D3D12_FEATURE_DATA_SHADER_MODEL));
