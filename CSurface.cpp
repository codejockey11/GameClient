...
void CSurface::Read(FILE* file)
{
	...
	/*
		Uploading a large amounts of static resources will dramatically increase load times
		(i.e. non-moving surfaces like walls and streets and well basically the entire static environment)
		I didn't notice a drawing issue with dynamic and assuming it's the shared ram between gpu and cpu with my desktop
