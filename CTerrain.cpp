	...
	const char* name, const char* filename)
{
	...
	m_shaderHeap->BindResource(1, m_materialConstantBuffer->m_buffer.Get(), &m_materialConstantBuffer->m_srvDesc);
	...
	m_overheadShaderHeap->BindResource(1, m_materialConstantBuffer->m_buffer.Get(), &m_materialConstantBuffer->m_srvDesc);
...
/*
*/
void CTerrain::RecordConstantBuffers()
{
	m_blendConstantBuffer->Record();
	
	m_materialConstantBuffer->Record();
}