...
/*
*/
CButton* CButtonManager::Create(const char* name, CFont* font, CWavLoader* soundOn, CWavLoader* soundOff, CWavLoader* soundClicked, CTexture* image, CVec2f position, CVec2f size,
	BYTE audience, BYTE type)
{
	...
	button = new CButton(m_graphicsAdapter, m_soundDevice, m_mouseDevice, m_errorLog, m_shaderBinaryManager, name, font, soundOn, soundOff, soundClicked, image, position, size,
		audience, type);
