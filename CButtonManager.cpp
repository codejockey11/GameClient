	...
	CTexture* image, CVec2f position, CVec2f size, BYTE audience, BYTE type)
{
	...
	m_button = new CButton(m_graphicsAdapter, m_soundDevice, m_mouseDevice, m_errorLog, m_pipelineState, listGroup, name, font, soundOn, soundOff, soundClicked, image, position, size,
		audience, type);
