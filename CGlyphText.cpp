...
/*
*/
CGlyphText::CGlyphText(CGraphicsAdapter* graphicsAdapter, CErrorLog* errorLog, CPipelineState* pipelineState, CGlyphFixed* glyphFixed, int32_t listGroup,
...
/*
*/
CGlyphText::CGlyphText(CGraphicsAdapter* graphicsAdapter, CErrorLog* errorLog, CPipelineState* pipelineState, CGlyphVariable* glyphVariable, int32_t listGroup,
	int32_t textLength, CVec2f position, float size)
{
	memset(this, 0x00, sizeof(CGlyphText));
...
void CGlyphText::AllocateResources()
{
	...
	m_constantBuffer->Constructor(m_graphicsAdapter, m_errorLog, sizeof(XMFLOAT4X4) + sizeof(XMFLOAT4));
...
/*
*/
void CGlyphText::RecordConstantBuffer()
{
