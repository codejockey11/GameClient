...
/*
*/
COverhead::COverhead(CGraphicsAdapter* graphicsAdapter, CErrorLog* errorLog, CLocal* local, CShaderBinaryManager* shaderBinaryManager, int bundle, CVec2f position, CVec2f size)
{
	memset(this, 0x00, sizeof(COverhead));
