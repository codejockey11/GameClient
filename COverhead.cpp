...
/*
*/
COverhead::COverhead(CGraphicsAdapter* graphicsAdapter, CErrorLog* errorLog, CLocal* local, CPipelineState* pipelineState, int32_t listGroup, int32_t listGroupClear,
	CVec2f position, CVec2f size)
{
	...
	m_commandAllocatorClear = new CCommandAllocator(m_graphicsAdapter, m_errorLog);
...
/*
*/
void COverhead::RecordConstantBuffer()
{
