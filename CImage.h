...
public:
	...
	CImage();
	CImage(CGraphicsAdapter* graphicsAdapter, CErrorLog* errorLog, CShaderBinaryManager* shaderBinaryManager, int32_t bundle, CTexture* texture, CVec2f position, CVec2f size);
	~CImage();
