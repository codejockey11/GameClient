...
public:
	...
	CImage();
	CImage(CGraphicsAdapter* graphicsAdapter, CErrorLog* errorLog, CPipelineState* pipelineState, int32_t listGroup, CTexture* texture, CVec2f position, CVec2f size);
	~CImage();
