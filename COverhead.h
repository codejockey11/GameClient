...
public:
	...
	COverhead();
	COverhead(CGraphicsAdapter* graphicsAdapter, CErrorLog* errorLog, CLocal* local, CShaderBinaryManager* shaderBinaryManager, int32_t bundle, CVec2f position, CVec2f size);
	~COverhead();
