...
/*
*/
CDepthBuffer::CDepthBuffer(CErrorLog* errorLog, ComPtr<ID3D12Device> device, UINT numDescriptors, UINT width, UINT height)
{
	memset(this, 0x00, sizeof(CDepthBuffer));
	...
	m_hr = device->CreateDescriptorHeap(&m_heapDesc, IID_PPV_ARGS(&m_heap));
