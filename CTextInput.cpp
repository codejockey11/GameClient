...
/*
*/
CTextInput::CTextInput(CGraphicsAdapter* graphicsAdapter, CMouseDevice* mouseDevice, CErrorLog* errorLog, CShaderBinaryManager* shaderBinaryManager, CFont* font, CTexture* image, CVec2f position, CVec2f size)
{
	memset(this, 0x00, sizeof(CTextInput));
