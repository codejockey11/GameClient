...
/*
*/
CTextInput::CTextInput(CGraphicsAdapter* graphicsAdapter, CMouseDevice* mouseDevice, CErrorLog* errorLog, CPipelineState* pipelineState, int32_t listGroup,
	CFont* font, CTexture* texture, CVec2f position, CVec2f size)
{
	...
	m_image = new CImage(m_graphicsAdapter, m_errorLog, pipelineState, listGroup, texture, m_position, m_size);
