...
CSound::CSound(CErrorLog* errorLog, CSoundDevice* soundDevice, const char* filename, bool loop)
{
	...
	m_xapoEcho.Delay = 500.0f;	// FXECHO_DEFAULT_DELAY;
	...
	// Enable multi-streaming on sound card or these won't work
	// Effects usually fail to instantiate from a hardware setting
