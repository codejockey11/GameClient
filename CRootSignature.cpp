...
/*
*/
void CRootSignature::Create(int count, D3D12_ROOT_PARAMETER1* pParameters)
{
	...
	m_hr = m_graphicsAdapter->m_device->CreateRootSignature(0, m_tempSignature->GetBufferPointer(), m_tempSignature->GetBufferSize(), IID_PPV_ARGS(&m_signature));
