...
public:
	...
	CTextInput();
	CTextInput(CGraphicsAdapter* graphicsAdapter, CMouseDevice* mouseDevice, CErrorLog* errorLog, CShaderBinaryManager* shaderBinaryManager, CFont* font, CTexture* texture,
