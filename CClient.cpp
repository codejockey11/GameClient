	...
	if (!m_model[m_serverInfo->m_clientNumber].m_isInitialized)
	{
		...
		while (mesh->m_object)
		{
			...
			case CServerInfo::E_TEAM_RED:
			{
				...
				m_model[m_serverInfo->m_clientNumber].m_shaderMaterials[mesh->m_object->m_material.m_number].m_ambient = XMFLOAT4(0.5f, 0.0f, 0.0f, 1.0f);
				m_model[m_serverInfo->m_clientNumber].m_shaderMaterials[mesh->m_object->m_material.m_number].m_emissive = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
			...
			case CServerInfo::E_TEAM_BLUE:
			{
				...
				m_model[m_serverInfo->m_clientNumber].m_shaderMaterials[mesh->m_object->m_material.m_number].m_ambient = XMFLOAT4(0.0f, 0.0f, 0.5f, 1.0f);
				m_model[m_serverInfo->m_clientNumber].m_shaderMaterials[mesh->m_object->m_material.m_number].m_emissive = XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f);
