...
CClient::CClient(CGraphicsAdapter* graphicsAdapter, CSoundDevice* soundDevice, CMouseDevice* mouseDevice, CKeyboardDevice* keyboardDevice, CErrorLog* errorLog, CLocal* local)
{
	...
	m_chatBox = new CChatBox(m_graphicsAdapter, m_errorLog, m_shaderBinaryManager, 5, buttonImage, consolas12, 1024, 400);
	...
	CTextInput* m_userid = new CTextInput(m_graphicsAdapter, m_mouseDevice, m_errorLog, m_shaderBinaryManager, 4, calibri12, buttonImage, CVec2f(100, 10), CVec2f(256, 14));
	CTextInput* m_password = new CTextInput(m_graphicsAdapter, m_mouseDevice, m_errorLog, m_shaderBinaryManager, 4, calibri12, buttonImage, CVec2f(100, 26), CVec2f(256, 14));

	m_login = new CPanel(m_graphicsAdapter, m_mouseDevice, m_errorLog, m_shaderBinaryManager, 4, m_cursor, buttonImage, m_fontArial, "Login", CVec2f(10, 10), CVec2f(400, 400));
...
void CClient::DrawLoading()
{
	...
	while ((pathNode) && (pathNode->m_object))
	{
		...
		CClient::DrawLoadingScreen(loadingScreen, m_data, (char*)"Pixel Shaders", (char*)path->m_text);
	...
	while ((pathNode) && (pathNode->m_object))
	{
		...
		CClient::DrawLoadingScreen(loadingScreen, m_data, (char*)"Vertex Shaders", (char*)path->m_text);
	...
	CClient::DrawLoadingScreen(loadingScreen, m_data, (char*)"Environment", (char*)"Loading ...");
	...
	CClient::DrawLoadingScreen(loadingScreen, m_data, (char*)"Load Environment Completed", (char*)"Waiting on the server ...");
...
void CClient::DrawScene()
{
	...
	*/
	...
	{
		for (UINT pz = 0; pz < m_map->m_visibility->m_sector->m_gridDepth; pz++)
		{
...
void CClient::QueSound()
{
	...
	m_index = atoi((char*)m_network->m_data);
